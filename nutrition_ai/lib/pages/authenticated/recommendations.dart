    ...
    recommendations = [
      ...
      [
        ...
        meal_model.Meal(
            ...
            ingredients: [
              Ingredient(name: "penne rigate", amount: "1 pound"),
              Ingredient(name: "olive oil", amount: "1/4 cup"),
              Ingredient(name: "garlic", amount: "3 cloves"),
              Ingredient(name: "chopped tomatoes", amount: "1 tin "),
              Ingredient(name: "red chile flakes", amount: "1/2 teaspoon"),
              Ingredient(name: "italian seasoning", amount: "1/2 teaspoon"),
              Ingredient(name: "basil", amount: "6 leaves"),
              Ingredient(name: "Parmigiano-Reggiano", amount: "spinkling"),
            ]),
        meal_model.Meal(
            ...
            ingredients: [
              Ingredient(name: "Salmon", amount: "1 lb"),
              Ingredient(name: "Olive oil", amount: "1 tablespoon"),
              Ingredient(name: "Soy Sauce", amount: "2 tablespoons"),
              Ingredient(name: "Sake", amount: "2 tablespoons"),
              Ingredient(name: "Sesame Seed", amount: "4 tablespoons"),
            ]),
      ],
      [
        meal_model.Meal(
            ...
            ingredients: [
              Ingredient(name: "mozzarella balls", amount: "200 g"),
              Ingredient(name: "baby plum tomatoes", amount: "250 g"),
              Ingredient(name: "fresh basil", amount: "1 bunch"),
              Ingredient(name: "farfalle", amount: "350 g"),
              Ingredient(
                  name: "extra virgin olive oil", amount: "3 tablespoons"),
              Ingredient(name: "Green Olives", amount: "40 g"),
              Ingredient(name: "tuna", amount: "200 g"),
        ...
        meal_model.Meal(
            ...
            ingredients: [
              Ingredient(name: "Olive Oil", amount: "1 tbls"),
              Ingredient(name: "Onion", amount: "1"),
              Ingredient(name: "Leek", amount: "1 chopped"),
              Ingredient(name: "Garlic", amount: "3 cloves"),
              Ingredient(name: "Cumin", amount: "4 tsp ground "),
              Ingredient(name: "Coriander", amount: "2 tsp ground"),
              Ingredient(name: "Smoked Paprika", amount: "1 tsp"),
              Ingredient(name: "Cinnamon", amount: "1/2 tsp"),
            ]),
        meal_model.Meal(
            ...
            ingredients: [
              Ingredient(name: "Miniature Marshmallows", amount: "2 cups"),
              Ingredient(name: "Chocolate Chips", amount: "3 cups"),
              Ingredient(name: "Peanut Butter", amount: " cup"),
              Ingredient(name: "Vanilla Extract", amount: "1 tsp"),
              Ingredient(name: "Peanuts", amount: "1 cups"),
            ]),
      ],
    ];
  }
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => meal_screen.Meal(
                                    meal: meal,
                                  ),
                                ),
                              );
